...
I am a seasoned DevOps/Platform Engineer, or as I prefer to call it, a **Software Supply Chain Automation Specialist**. Currently, I'm working at [Scale AI](https://scale.com/), delivering sovereign AI solutions across the globe. 

Building a platform is just laying down the bricks. The real engineering challenge is the Software Supply Chain: the hardened, automated movement of logic across immovable foundations. I focus on building the "factory" that ensures high-stakes code remains secure, verifiable, and portable, regardless of where the bricks are laid.
...
* [xNok/hugo-quickstart](https://github.com/xNok/hugo-quickstart): Simply and Quickly get started with Github Pages
